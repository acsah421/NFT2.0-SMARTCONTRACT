 ...
 */
contract PrimaryAuctionNFTMarketPlace is
    ...
    EIP712
{
  ...
  */
    ...
    constructor(
        ...
        address _rootAdmin
    ) EIP712("PrimaryAuctionNFTMarketPlace", "0.0.1") {
    ...
    function placeBid(
        ...
        if (NftOnAuction.erc20Token == address(0)) {
            ...
            require(
                ...
                "Place Bid: Amount received should be grather than the current bid"
            );
    ...
    function instantBuyNFT(
        ...
        if (NftOnAuction.erc20Token == address(0)) {
            ...
            require(
                ...
                "Auction Instant Buy: Allowance is Less then Price"
            );
    ...
    function _NftAuction(
        ...
        Auction storage _nftOnAuction = mapAuction[_nftAddress][_tokenId][
            _auctioner
        ];
        _mintNFT(
            _buyer,
    ...
    function _verifySignature(
        ...
        address signer = _getSigner(
            _hashTypedData(tokenId, auctioner, nftAddress, _nftInfo),
            signature
        );
        require(
    ...
    function _validateMetadata(
        ...
        require(
            ...
            "Genaral Validation: Zero Sender Address"
        );
        require(
            _nftAddress != address(0),
            "Genaral Validation: Zero NFT Address"
        );
        require(
            _auctioner != address(0),
            "Genaral Validation: Zero Auctioner Address "
        );
        require(
            _isNFT(_nftAddress),
            "Genaral Validation: Not confirming to an NFT contract"
        );
        require(
            NftOnAuction.quantity != 0,
            "Genaral Validation: Zero Quantity"
        );
        require(
            NftOnAuction.tokenId == _tokenId,
            "Genaral Validation: Token id is not on auction"
        );
